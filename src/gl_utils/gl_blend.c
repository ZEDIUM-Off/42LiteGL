...
/*   Updated: 2023/03/09 12:31:25 by  mchenava        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <lite_gl.h>

void	gl_blend_func(t_GLContext *c, t_gl_enum sfactor, t_gl_enum dfactor)
{
...
void	gl_blend_equation(t_GLContext *c, t_gl_enum mode)
{
...
void	gl_blend_color(t_GLContext *c, t_gl_clampf *color)
{
